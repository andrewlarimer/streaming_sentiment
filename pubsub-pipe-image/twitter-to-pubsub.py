...
if __name__ == '__main__':
    ...
    entities = ['Tyrion', 'Sansa', 'Dany', 'Daenerys',
    'Jon', 'Arya', 'Bran', 'Grey Worm', 'Drogon',
    'Bronn', 'Brienne', 'Tormund', ' Sam ', 'Gilly', 'Gendry',
    'Hound', 'Cleganebowl', 'Clegane Bowl', 'Cersei', 'Jamie', 'Jaime',
    'Missandei', 'D&D', 'GRRM', '#GoT', 'Game of Thrones writers']
